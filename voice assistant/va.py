...
def handle_find_object(obj_detector):
    ...
    if object_name.lower() not in [name.lower() for name in obj_detector.classNames]:
        speak("I'm sorry, but I don't recognize that object.")
        return
    # rest of your code

    speak(f"Searching for {object_name}...")
    
    # Assuming obj_detector has been started and is running in a separate thread
